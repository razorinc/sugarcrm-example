...
$sugar_config_si = array (
    'setup_db_host_name' => trim($_ENV['OPENSHIFT_DB_HOST']).':'.trim($_ENV['OPENSHIFT_DB_PORT']),
    ...
    'setup_db_admin_user_name' => $_ENV['OPENSHIFT_DB_USERNAME'],
    'setup_db_admin_password' => $_ENV['OPENSHIFT_DB_PASSWORD'],
    ...
    'dbUSRData' => 'same',
    'setup_db_sugarsales_user' => $_ENV['OPENSHIFT_DB_USERNAME'],
    'setup_db_sugarsales_password' => $_ENV['OPENSHIFT_DB_PASSWORD'],
    'setup_db_type' => 'mysql',
